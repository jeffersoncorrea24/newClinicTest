...
<body>
                ...
                <div class="container-fluid">
                                            ...
                                            <div class="row" style="margin: 0% 32%">
                                                <div class="col-12 mt-2" style="text-align: center; background: #f1f0f0; border-radius: 40px; padding: 20px 0px; box-shadow: 0px 0px 20px #8a8888; border: 1px solid #de3b9b;">
                                                    <form action="../../app/controller/encriptar_usuario.php" method="post" class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12 mt-1">
                                                          <label for="" style="font-weight: bold;">Nueva contraseña</label>
                                                            <div><input type="password" name="clave" id="clave" class="crea_data" maxlength="29" autocomplete="off" autofocus style="border-radius:  5px; padding: 3px 4px;
                                                     ...
                                                     <div class="row">
                                                          <div class="col-12 mt-1">
                                                           <label for="" style="font-weight: bold;">Confirmación de Contrasena</label>
                                                             <div><input type="password" name="nuevaClave" id="nuevaClave" class="crea_data" maxlength="29" autocomplete="off" autofocus required style="border-radius:  5px; padding: 3px 4px;">
                                                        </div>
                                                    </div>
    ...
    <script src="../../public/js/encriptacion_usuario.js"></script>
